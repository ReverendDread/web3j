...
public class JsonRpc2_0Web3j implements Web3j {
    ...
    @Override
    public Request<?, EthProof> ethGetProof(String address, List<String> storageKeys, DefaultBlockParameter defaultBlockParameter) {
        return new Request<>("eth_getProof", Arrays.asList(address, storageKeys, defaultBlockParameter.getValue()), web3jService, EthProof.class);
    }
